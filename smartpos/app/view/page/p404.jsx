...
export default class P404 extends React.Component {
	...
	render() {
		//
		return(
			<div className="container-fluid a-notfound">
				<div className="row">
					<div className="col-sm-12 text-center an-head">
						<p className="anh-logo"><a href='#/'><img alt="RetailSmart POS" src={Config.STATIC_ROOT + 'res/smplpos-white.png'} /></a></p>
						<h1>404</h1>	
